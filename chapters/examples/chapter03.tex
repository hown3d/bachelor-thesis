...
%
Let the $b_i(j)$ be i.i.d. random variables with mean $\mu$ and variance $\sigma^2$ and let $M=2$. For $k,l \gg 1$ (siehe \ref{eq:chapter03:exactpmf}) is approximately Gaussian where
%
\begin{equation*}
...
\begin{proof}
%
For $M=2$ we have from (siehe \ref{eq:chapter03:exactpmf}) that
%
\begin{equation*}
